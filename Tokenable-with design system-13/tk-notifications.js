...
var NOTIFS = [
  { type:'bid', icon:'layer', color:'#1A6FFF', href:'Portfolio.html?tab=bids', title:'Top bid updated', desc:'The highest bid on your 1999 Charizard Holo \u00b7 PSA 10 is now $399,000.', time:'Just now', img:'images/card-charizard.png', cta:{ label:'Edit price', href:'Portfolio.html?setprice='+encodeURIComponent('1999 Pok\u00e9mon Base Set #4 Charizard Holo \u00b7 PSA 10')+'&val=420000&bid=399000' } },
  { type:'vault', icon:'shield', color:'#1A6FFF', href:'Ship-From-Vault.html', title:'Redemption confirmed', desc:'Payment received \u2014 your cards are being prepared for shipping.', time:'5 min ago', img:'images/card-pikachu.png', cta:{ label:'Confirm & pay', href:'Ship-From-Vault.html?state=pay' } },
  { type:'trade', icon:'check', color:'#00C350', href:'P2P-Buyer-Receipt.html', title:'Trade Confirmed', desc:'Your purchase of Charizard 1st Ed Base Set PSA 10 has been confirmed.', time:'2 min ago', img:'images/card-charizard.png' },
  { type:'bid', icon:'layer', color:'#1A6FFF', href:'Portfolio.html?tab=bids', title:'Bid Accepted', desc:'Your bid of $58,000 on LeBron James Rookie Chrome BGS 9.5 was accepted.', time:'1 hour ago', img:'images/card-lebron.png' },
  { type:'price', icon:'trend', color:'#EA8200', href:'Markets.html', title:'Price Alert', desc:'Pikachu ex Surging Sparks PSA 10 is up +12% in the last 24 hours.', time:'3 hours ago', img:'images/card-pikachu.png' },
  { type:'vault', icon:'shield', color:'#1A6FFF', href:'Vault-Dashboard-Active.html', title:'Card Vaulted', desc:'Your Luka Dončić Blue Ice Prizm BGS 9.5 has been received and vaulted.', time:'Yesterday' },
  { type:'trade', icon:'check', color:'#00C350', href:'P2P-Shipping.html', title:'Sale Complete', desc:'Nidoking ex PSA 10 sold for $58,000. Funds deposited to your wallet.', time:'2 days ago', img:'images/card-nidoking.jpg' },
  { type:'bid', icon:'layer', color:'#1A6FFF', href:'Portfolio.html?tab=bids', title:'New Bid Received', desc:'You received a bid of $400,000 on Charizard 1st Ed Base Set PSA 10.', time:'3 days ago' },
  { type:'vault', icon:'shield', color:'#1A6FFF', href:'Vault-Dashboard-Active.html', title:'Insurance Renewed', desc:'Vault insurance for all 23 assets has been renewed for another year.', time:'1 week ago' },
  { type:'price', icon:'trend', color:'#EA8200', href:'Markets.html', title:'Market Update', desc:'The PSA 10 Charizard index is up +5.2% this week. View market trends.', time:'1 week ago' },
  { type:'trade', icon:'check', color:'#00C350', href:'Portfolio.html?tab=history', title:'Trade Settled', desc:'Your purchase of Pikachu VMAX Rainbow PSA 10 has settled on-chain.', time:'2 weeks ago', img:'images/card-pikachu-ex.png' },
];
