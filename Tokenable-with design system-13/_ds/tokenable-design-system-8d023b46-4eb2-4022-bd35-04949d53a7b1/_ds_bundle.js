...
function Notification({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    className: "tk-note__actions"
  }, action.secondary ? /*#__PURE__*/React.createElement("button", {
    className: "tk-note__action tk-note__action--ghost",
    onClick: action.onSecondary
  }, action.secondary) : null, /*#__PURE__*/React.createElement("button", {
    className: `tk-note__action tk-note__action--${scheme}`,
