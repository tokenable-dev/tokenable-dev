...
function considerationRecipientsFromParams(
  ...
  const out: string[] = [];
  for (const c of cons) {
    if (c && typeof c === 'object' && typeof (c as { recipient?: string }).recipient === 'string') {
...
export function orderToListItem(o: Order): OrderListItem {
  ...
  return {
    ...
    updatedAt:
      o.updatedAt instanceof Date ? o.updatedAt.toISOString() : o.updatedAt != null ? String(o.updatedAt) : undefined,
    offerer: o.offerer,
