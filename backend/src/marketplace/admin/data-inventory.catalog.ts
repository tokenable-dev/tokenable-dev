...
export const DATA_STORE_CATALOG: DataStoreCatalogEntry[] = [
  ...
  {
    id: 'vault_redeem_payment_claims',
    table: 'vault_redeem_payment_claims',
    domain: 'vault',
    label: '리딤 결제 클레임',
    description:
      'payment_tx_hash당 1회 — 배치 합계 USDC. 리딤 행이 이 해시를 참조.',
    howAccumulated: '리딤 결제 확인 시 삽입.',
    adminPagePath: '/marketplace/admin/redeems',
  },
  {
    id: 'vault_psa_arrival_reviews',
    table: 'vault_psa_arrival_reviews',
    domain: 'vault',
    label: 'PSA 입고 리뷰',
    description: 'PSA Items Received 메일 → 제출 패키지 매칭·확인.',
    howAccumulated: 'Gmail 폴링 또는 어드민 수동 확인.',
    adminPagePath: '/marketplace/admin/vault/psa-mail',
  },
  {
    id: 'vault_psa_vaulted_reviews',
    table: 'vault_psa_vaulted_reviews',
    domain: 'vault',
    label: 'PSA Vaulted 리뷰',
    description: 'PSA Vaulted 메일 매칭·확인.',
    howAccumulated: 'Gmail 폴링 또는 어드민 수동 확인.',
    adminPagePath: '/marketplace/admin/vault/psa-mail',
  },
  {
    id: 'marketplace_notifications',
    table: 'marketplace_notifications',
    domain: 'trading',
    label: '인앱 알림',
    description: '비드/체결/볼트/시세 알림 — recipient_wallet + chain_id.',
    howAccumulated: '주문·볼트·시세 이벤트 시 insert.',
    adminPagePath: null,
  },
  {
    id: 'self_vault_settlements',
    table: 'self_vault_settlements',
    domain: 'trading',
    label: '셀프볼트 정산',
    description: 'self_vault_hold 체결 후 판매자 USDC 지급 원장.',
    howAccumulated: '체결 시 생성, 크론/어드민이 지급.',
    adminPagePath: '/marketplace/admin/self-vault-payouts',
  },
  {
    id: 'marketplace_partner_addresses',
    table: 'marketplace_partner_addresses',
    domain: 'catalog',
    label: '파트너 Origin 주소',
  ...
  },
  {
    ...
    table: 'rwa_owner_index_cursors',
    domain: 'catalog',
    label: 'RWA 소유자 인덱스 커서',
    description: '컨트랙트별 Transfer 로그 백필 커서.',
    howAccumulated: '오너 인덱스 워커가 전진.',
    adminPagePath: '/marketplace/admin/cards',
  },
  {
    id: 'marketplace_admins',
    table: 'marketplace_admins',
    domain: 'people',
    label: '마켓 어드민 계정',
    description: '어드민 콘솔 로그인 자격.',
    howAccumulated: '시드/환경변수 부트스트랩.',
    adminPagePath: null,
  },
  {
    id: 'user_auth_providers',
    table: 'user_auth_providers',
    domain: 'people',
    label: '로그인 프로바이더',
    description: 'Privy에서 동기화한 email/Google/wallet 등.',
    howAccumulated: '세션 싱크마다 upsert.',
    adminPagePath: '/marketplace/admin/users',
  },
  {
    id: 'user_shipping_addresses',
    table: 'user_shipping_addresses',
    domain: 'people',
    label: '배송지',
    description: 'Settings 주소록 + 리딤 배송지.',
    howAccumulated: '유저가 주소 저장 시.',
    adminPagePath: '/marketplace/admin/users',
  },
  {
    id: 'user_buyer_listing_alert',
    table: 'user_buyer_listing_alert',
    domain: 'portfolio',
    label: '첫 리스팅 알림',
    description: '컬렉션에 첫 ask가 달렸을 때 1회 알림 기록.',
    howAccumulated: '첫 활성 ask 생성 시.',
    adminPagePath: null,
  },
];
