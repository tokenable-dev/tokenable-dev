...
import { CollectionMarketSnapshotController } from './collection-market-snapshot.controller';
 ...
 *
 * forwardRef(MarketplaceCollectionsModule): see comment in MarketplaceCollectionsModule.
 * This module exports the three snapshot services; CollectionsModule consumes them
 * through CollectionMarketService. Both sides must use forwardRef to break the cycle.
 */
@Module({
  imports: [
  ...
  controllers: [CollectionMarketSnapshotController],
  providers: [
