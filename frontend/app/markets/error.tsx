...
/**
 * Surfaces client/runtime errors on /markets (otherwise the route can look blank with no console noise).
 */
export default function MarketsError({
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16 text-white">
      <h1 className="text-lg font-semibold text-red-400">Markets failed to render</h1>
