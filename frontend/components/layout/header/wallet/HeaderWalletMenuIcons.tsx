...
export function WalletRedeemRequestsIcon(props: IconProps) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" {...props}>
...
export function WalletAddFundsIcon(props: IconProps) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" {...props}>
...
export function WalletVerifyIcon(props: IconProps) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" {...props}>
...
/** Clipboard copy — matches `tk-wallet.js` / `tk-mobile-nav.js` `.tk-copy-addr`. */
export function WalletCopyAddrIcon(props: IconProps) {
  return (
...
export function WalletCopyCheckIcon(props: IconProps) {
  return (
    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.6" {...props}>
