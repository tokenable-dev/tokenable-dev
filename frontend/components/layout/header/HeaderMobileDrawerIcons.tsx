...
export function MobileDrawerChevronIcon(props: IconProps) {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" {...strokeProps} {...props}>
...
export function MobileDrawerRedeemRequestsIcon(props: IconProps) {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" {...strokeProps} {...props}>
