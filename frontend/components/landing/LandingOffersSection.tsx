...
const OFFER_ICON_BASE_CLASS =
  "mx-auto h-20 w-20 object-contain object-center sm:h-24 sm:w-24 md:h-28 md:w-28";
  ...
  return (
    <div className="flex flex-col items-center text-center">
      ...
      <img
        ...
        width={112}
        height={112}
        className={`${OFFER_ICON_BASE_CLASS}${invertIcon ? " invert" : ""}`}
        aria-hidden
      />
...
export function LandingOffersSection() {
  return (
    <section className="relative z-10 mx-auto max-w-6xl border-t border-white/[0.06] px-6 py-16 sm:max-w-7xl sm:py-24">
      <h2 className="mb-14 text-center text-2xl font-medium leading-snug text-gray-400 sm:mb-20 sm:text-3xl md:text-4xl lg:text-[2.75rem]">
