...
export const AUTH_PROVIDER_BTN =
  "flex w-full items-center justify-center gap-2.5 rounded-xl border border-gray-700/80 bg-gray-800/40 py-3 text-sm font-semibold text-white transition-colors hover:border-mint/35 hover:bg-gray-800/70 disabled:cursor-not-allowed disabled:opacity-50";

export const AUTH_MINT_LINK =
