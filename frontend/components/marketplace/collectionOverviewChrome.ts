...
/** Outer rim — same fill as inner. */
export const COLLECTION_MARKET_CLUSTER_BEZEL =
  `p-[4px] sm:p-[5px] rounded-[1.35rem] ${COLLECTION_DETAILS_BG_CLASS}`;

/** Inner mat — same panel color as bezel. */
export const COLLECTION_MARKET_CLUSTER_MAT =
  `rounded-[1.2rem] ${COLLECTION_DETAILS_BG_CLASS} p-3 sm:p-3.5 lg:p-4`;
