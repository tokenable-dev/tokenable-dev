...
export const AI_INSIGHT_THEME_DARK: AiInsightPanelTheme = {
  ...
  bodyMuted: "text-[11px] text-zinc-400",
  bullet:
  ...
  priceChange: "text-[11px] text-zinc-400",
  chartCaption: "mt-2 text-[11px] leading-relaxed text-zinc-500",
  ...
  ctaButton: "rounded-lg bg-mint px-4 py-2 text-[11px] font-bold text-[#0a0a0a] hover:bg-mint/90",
  ...
  accentLabel: "mb-2 text-[11px] font-semibold uppercase tracking-wide text-mint/90",
  ...
  expandHint: "text-[11px] text-zinc-500",
  error: "text-[11px] text-red-400",
  emptyChart:
    "flex h-[140px] items-center justify-center rounded-xl border border-zinc-800/80 bg-zinc-950/40 text-[11px] text-zinc-500",
  identityRow:
...
export const AI_INSIGHT_THEME_LIGHT: AiInsightPanelTheme = {
  ...
  bodyMuted: "text-[11px] text-zinc-600",
  bullet:
  ...
  priceChange: "text-[11px] text-zinc-600",
  chartCaption: "mt-2 text-[11px] leading-relaxed text-zinc-600",
  platformFooter:
  ...
  ctaButton:
    "rounded-lg bg-zinc-900 px-4 py-2 text-[11px] font-bold text-white hover:bg-zinc-800",
  ...
  accentLabel: "mb-2 text-[11px] font-semibold uppercase tracking-wide text-emerald-700",
  ...
  expandHint: "text-[11px] text-zinc-600",
  error: "text-[11px] text-red-600",
  emptyChart:
    "flex h-[140px] items-center justify-center rounded-lg border border-zinc-200 bg-zinc-50 text-[11px] text-zinc-600",
  identityRow:
