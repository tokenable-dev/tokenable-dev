...
export function collectionTradingSectionClassName(input: {
  ...
  return `min-w-0 w-full max-w-full overflow-hidden rounded-xl ${COLLECTION_DETAILS_BORDER_ALL} ${COLLECTION_DETAILS_BG_CLASS} shadow-[0_20px_50px_-28px_rgba(0,0,0,0.85)] ring-1 ring-[rgba(11,13,16,1)]`;
}
