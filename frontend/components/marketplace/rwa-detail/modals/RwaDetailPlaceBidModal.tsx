  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end justify-center px-0 py-0 sm:items-center sm:px-4 sm:py-8">
      ...
      <div
        ...
        className={`relative flex max-h-[min(88svh,520px)] w-full max-w-[min(100%,26rem)] flex-col overflow-hidden rounded-t-2xl border border-zinc-700/90 bg-zinc-950 shadow-xl shadow-black/40 sm:rounded-2xl ${rwaDetailRightFont.className}`}
      >
