...
function buildDrawer(){
  ...
  NOTIFS.forEach(function(n){
    items += '<div class="tk-notif-item" data-type="'+n.type+'" style="display:flex;gap:14px;padding:16px 0;border-bottom:1px solid rgba(255,255,255,0.04);cursor:pointer;transition:background 0.1s;">' +
...
s.textContent = [
  ...
  '  #tk-notif-overlay{align-items:flex-end;justify-content:center;}',
  '  #tk-notif-panel{width:100%;height:100vh;max-height:100vh;border-radius:0;transform:translateY(100%);box-shadow:0 -8px 32px rgba(0,0,0,0.5);}',
  '  #tk-notif-overlay[data-open] #tk-notif-panel{transform:translateY(0);}',
  '}',
].join('\n');
