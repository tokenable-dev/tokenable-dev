...
function injectDropdown(wrap){
  ...
  dd.innerHTML = [
    ...
    '</div>',
    '<!-- Menu items -->',
    '<a href="Portfolio.html" class="tk-wd-item">',
    ...
    '  My Portfolio',
    '</a>',
    '<a href="Portfolio.html?tab=bids" class="tk-wd-item tk-wd-sub">',
    ...
    '  Active Bids',
    '</a>',
    '<a href="Portfolio.html?tab=history" class="tk-wd-item tk-wd-sub">',
...
function injectMobileWallet(){
  ...
  section.innerHTML = [
    ...
    '</div>',
    '<a href="Portfolio.html" class="tk-mw-link">',
    '  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect></svg>',
    '  My Portfolio',
    '</a>',
    '<a href="Portfolio.html#bids" class="tk-mw-link" style="padding-left:16px;font-size:14px;color:rgba(255,255,255,0.6);">',
    '  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg>',
    '  Active Bids',
    '</a>',
    '<a href="Portfolio.html#history" class="tk-mw-link" style="padding-left:16px;font-size:14px;color:rgba(255,255,255,0.6);">',
    '  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>',
    '  Transaction History',
    '</a>',
