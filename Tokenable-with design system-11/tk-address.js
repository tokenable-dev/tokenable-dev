...
var RULES = {
  us:   { name:'United States', postal:/^\d{5}(-\d{4})?$/, postalEg:'94103', region:'State', phone:[10] },
  ca:   { name:'Canada', postal:/^[A-Za-z]\d[A-Za-z][ -]?\d[A-Za-z]\d$/, postalEg:'M5V 2T6', region:'Province', phone:[10] },
  gb:   { name:'United Kingdom', postal:/^[A-Za-z]{1,2}\d[A-Za-z\d]? ?\d[A-Za-z]{2}$/, postalEg:'NW1 6XE', region:'County', phone:[10,11] },
  de:   { name:'Germany', postal:/^\d{5}$/, postalEg:'10117', region:'State', phone:[10,11] },
  fr:   { name:'France', postal:/^\d{5}$/, postalEg:'75008', region:'Region', phone:[9] },
  nl:   { name:'Netherlands', postal:/^\d{4} ?[A-Za-z]{2}$/, postalEg:'1012 AB', region:'Province', phone:[9] },
  jp:   { name:'Japan', postal:/^\d{3}-?\d{4}$/, postalEg:'131-0045', region:'Prefecture', phone:[10,11] },
  kr:   { name:'South Korea', postal:/^\d{5}$/, postalEg:'06021', region:'Province or city', phone:[9,10] },
  au:   { name:'Australia', postal:/^\d{4}$/, postalEg:'2000', region:'State', phone:[9] },
  sg:   { name:'Singapore', postal:/^\d{6}$/, postalEg:'238859', region:'Region', phone:[8] },
...
function validate(fields, opts){
  ...
  if(phone !== null){
    ...
    if(R.phone.indexOf(digits.length) < 0){
