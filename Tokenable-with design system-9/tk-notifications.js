...
var NOTIFS = [
  ...
  { type:'vault', icon:'shield', color:'#1A6FFF', href:'Redeem.html', title:'Redemption confirmed', desc:'Payment received \u2014 your cards are being prepared for shipping.', time:'5 min ago', img:'images/card-pikachu.png', cta:{ label:'Confirm & pay', href:'Redeem.html?state=pay' } },
