...
function makeCardTexture(i){
  ...
  g.fillStyle='#0a0a0b';g.font='700 30px Inter, sans-serif';g.textAlign='center';
...
function initCards(){
  ...
  var d1=new T.DirectionalLight(0xffffff,1.5);d1.position.set(3,5,6);scene.add(d1);
